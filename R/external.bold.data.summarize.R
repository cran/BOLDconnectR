...
#'
#' test.data.summary.concise <- bold.data.summarize(
#'   bold_df = bold.data,
...
#'
#' test.data.summary <- bold.data.summarize(
#'   bold_df = bold.data,
...
#'
#' test.data.summary.completeness <- bold.data.summarize(
#'   bold_df = bold.data,
...
#'
#' test.data.summary.barcode <- bold.data.summarize(
#'   bold_df = bold.data,
